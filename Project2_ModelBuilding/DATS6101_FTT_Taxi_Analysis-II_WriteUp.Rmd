...
```{r scatterplots, include=F, echo=F}
if(FALSE) {
...
Let us Start building our linear model with tip amount instead of tip fare ratio with first 3 high Pearson Correlation values for 'Tip_Amount'. fare_amount, trip_distance, trip_duration eere highly correlated variables to tip fare ratio with 0.91, 0.83, 0.71 as pearson coefficients respectively.

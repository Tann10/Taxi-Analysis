...
Based on our EDA, we can begin to sketch out an answer to our question. It appears that the following variables may affect the tip ratio for those who paid by credit card: pickup loation, dropoff location, distance travelled in miles, time of day and passenger count. Using these variables, we will try to predict tip fare ratio. 

## Correlation
For this step, we have used Pearson correlation method to indicate the extent to which two variables are linearly related. Here, y-variable is tip_fare_ratio.
...
Let us Start building our linear model with first 3 high Pearson Correlation values for 'Tip_Fare_Ratio'. trip_duration fare_amount trip_distance were highly correlated variables to tip fare ratio with -0.31, -0.27, -0.23 as pearson coefficients respectively.

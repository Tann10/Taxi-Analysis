...
The results are good. To further improve them we perform step by feature selection.
Below is the tip_amount ~ . step by feature selection with Adjusted R^2 scaling
...
From the graph above we see that Adj R^2 remians constant throughout. Hence we select fare_amount, congestion_surcharge, Borough_do_Bronxn as our first three features that give maximum Adj R^2 = 0.83.

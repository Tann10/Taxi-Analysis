...
Since our data problem falls under regression we chose decision trees and Linear(uni,multivariate) regression models and find the best one that suits our data. We also applied step by feature selection, Lasso, Ridge and Elastic Net and PCA to improve our linear model. Let us look into them in details below.

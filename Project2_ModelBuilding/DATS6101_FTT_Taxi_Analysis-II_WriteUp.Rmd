...
With significance level of 0.05, we got a p-value very close to zero. wee have enough evidence to reject the null hypothesis in favor of alternate hypothesis meaning that people travelling through yellow cabs in NYC tip differently based on distance travelled.
...
For this step, we have Pearson's correlation method to indicate the extent to which two variables are linearly-related. Here, y-variable is tip-fare ratio.
...
We observe that p is greater than 0.05 for the third fit, which implies that fit 2 and fit 1 are the same.
...
As most of our variables were correlated with each other, and there were around 27 number of features, we decided to use PCA as a variable reduction technique.

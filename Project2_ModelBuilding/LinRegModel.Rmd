...
fit2 <- lm(tip_fare_ratio ~ fare_amount+pickup_hrs, data = taxipro )
summary(fit2)
vif(fit2)
plot(fit2)


fit3 <- lm(tip_fare_ratio ~ fare_amount+pickup_hrs+dropoff_hrs, data = taxipro )
summary(fit3)
vif(fit3)
plot(fit3)
...
fit4 <- lm(tip_fare_ratio ~ fare_amount+pickup_hrs+dropoff_hrs+trip_distance, data = taxipro )
summary(fit4)
vif(fit4)
plot(fit4)

fit5 <- lm(tip_fare_ratio ~ fare_amount+pickup_hrs+dropoff_hrs+trip_distance+DOLocationID, data = taxipro )
summary(fit5)
vif(fit5)
plot(fit5)
```
...
fit6 <- lm(tip_fare_ratio ~ fare_amount+pickup_hrs+dropoff_hrs+trip_distance+DOLocationID+PULocationID, data = taxipro )
summary(fit6)
vif(fit6)
plot(fit6)

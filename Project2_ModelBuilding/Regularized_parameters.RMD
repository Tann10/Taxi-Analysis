...
ggplot(df_sub, aes(x=trip_distance, y=tip_amount)) + 
  ...
  geom_smooth(method=lm, color = "black") +  labs(title="Variation in trip distance and tip amount",
       x="Trip distance", y = "Tip amount")


ggplot(df_sub, aes(x=trip_duration, y=tip_amount)) + 
  geom_point(color = "red")+
  geom_smooth(method=lm) +  labs(title="Variation in trip duration and tip amount",
       x="Trip duration", y = "Tip amount")

ggplot(df_sub, aes(x=congestion_surcharge, y=tip_amount)) + 
  geom_point(color = "red")+
  geom_smooth(method=lm) +  labs(title="Variation in congestion surcharge and tip amount",

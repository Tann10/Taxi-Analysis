...
# Model <- c("Linear", "Ridge", "Lasso", "Elastic Net", "Decision Tree")
# Rsquared <- c(1,2,3, df_elnet$Rsquare, 5)
# MAPE <- c(1,2,3, df_elnet$mape, 5)
# Significant_Variables <- c(1,2,3, 20, 5)
# 
# result_tbl <- data.frame(Model, Rsquared, MAPE, Significant_Variables)
# formattable(result_tbl, 
#             align =c("l","c","c","c","c"), 

...
##correlation of all the variables with Y lables(Fare_Tip_ratio & Fare_Amount)
...
mod_tip_ratio <- regsubsets(tip_amount ~ .-tip_fare_ratio-fare_amount, data = train, nvmax = 14, nbest = 1, method = "backward")
# plot(mod_tip_ratio, scale = "Cp", main = "Cp")
# plot(mod_tip_ratio, scale = "adjr2", main = "Adjusted R^2")
plot(mod_tip_ratio, scale = "r2", main = "R^2")
# plot(mod_tip_ratio, scale = "bic", main = "BIC")
...
results_df <-results_df[order(results_df$dependent),]

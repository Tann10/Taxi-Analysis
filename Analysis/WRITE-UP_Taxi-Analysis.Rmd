...
Similarly, we check the distribution for the vendor ID and run t test to check the results. The P value `r format(ttest_vendor$p.value, digits=3)` is less than 0.05; hence we reject null hypothesis and conclude that the vendor does affect tip amount.

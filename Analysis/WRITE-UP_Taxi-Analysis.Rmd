...
I CREATED ROWS AND COLUMNS, SIMPLY FILL IN YOUR ROW WITH THE RELEVANT INFORMATION
...
AMNA | ANOVA | number | means are equal | reject H0 |  
pickup time | ANOVA | number | means are equal | reject H0 |  
dropoff time| ANOVA | number | means are equal | reject H0 |  

...
Source: https://www1.nyc.gov/site/tlc/about/tlc-trip-record-data.page
  ...
  ### Normality Test
  A normal distribution is often an assumption for many statistical analyses. In order to conduct hypothesis testing we need to first check if data is normally distributed.  Below is the distribtuion of the tip amount does not look normal and there are some outliers.

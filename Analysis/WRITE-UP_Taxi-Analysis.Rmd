...
cor(processed_df$tip_fare_ratio, processed_df$trip_distance, method="pearson") 
cor(processed_df$tip_fare_ratio, processed_df$trip_duration, method="pearson") 

```
```{r dist_code, include = T, echo = F}
# Subset data 

...
Looking at the distribution of raw tip amount, it is clear that it is not normally distributed and that there are some outliers. As the data is not normally distributed, a ratio of tip amount to the fare amount was calculated and used as a dependent variable.

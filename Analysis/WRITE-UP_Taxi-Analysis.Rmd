...
# Dataset Procurement and Processing
...
The source dataset used for the project was taken from New York City Taxi and Limousine Commission website (2019), an official NYC government webpage (https://www1.nyc.gov/site/tlc/about/tlc-trip-record-data.page).
...
The dataset is available for Yellow Taxi, Green Taxi and For-Hire Vehicle Records from 2009 to 2019. The total size of the complete dataset is over 10 GB. We have randomly selected 20,000 observations from the latest dataset ie 2019 June from Yellow Taxi Records. due to hardware limitations, which have prevented us from analyzing the entire dataset.

## About the Dataset

  Below is the summary of the random sampled dataset (min, max, unique, column type) table:
  
  The New York City Taxi and Limousine Commission (2018) also provides a data dictionary to describe the columns and values in the dataset.

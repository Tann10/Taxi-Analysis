...
After checking normality and treating outliers, the scope of the initial question was changed to *analysing if factors such as location, duration, passenger count and time of the day affect to the ratio of the tip amount and the fare amount paid by credit card*
...
In this section, we analyze various factors that may affect the tipping amount paid to the cab drivers using a subset of yellow taxi New York City data pertaining to June 2019.
...
This tipping behaviour might happen because of psychological reasons e.g. passengers whose average fare amount sums up to $10-$15 would feel guilt-ridden if they pay tip less than $2-$3. On the other hand, those passengers who are already paying big chunks of money from their pockets in the form of fare amount that ranges between $25-$30 per commute would not feel that bad paying the same amount of tip just to cut down their costs. But this is just a hypothesis; there might be a variety of other reasons affecting this particular behaviour, as discussed in our literature review. 
...
Similarly, we check the distribution for the vendor ID and run t test to check the results. The P value `format(r ttest_vendor$p.value, digits=3)` is less than 0.05; hence we reject null hypothesis and conclude that the vendor does affect tip amount.

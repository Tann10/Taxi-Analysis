...
ggplot(data = processed_df, aes(x = pickup_period, y = per_tip, fill = pickup_period)) + ggtitle("Tip Percentage by Pickup Time Period") + geom_boxplot() + xlab("Time Period") + ylab("Trip Frequency")
...
ggplot(data = processed_df, aes(x = drop_period, y = per_tip, fill = drop_period)) + ggtitle("Tip Percentage by Dropoff Time Period") + geom_boxplot() + xlab("Time Period") + ylab("Trip Frequency")
...
<<<<<<< HEAD:Analysis/COMBINED_Taxi-Analysis.Rmd
a <- summary(processed_df$trip_distance)
a
=======
# Print summary
summary(processed_df$trip_distance)
>>>>>>> dd0232e757de4c98372de4cd5a0f52c1ea6a3033:Analysis/Taxi-Analysis.Rmd
# str(processed_df)
names(a)
```

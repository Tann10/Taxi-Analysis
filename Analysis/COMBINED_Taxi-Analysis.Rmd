...
processed_df %>%
  ...
  geom_boxplot() +
  theme(legend.position = "none") +
  labs(y = "Percentage tip amount [$]", x = "Number of passengers") + ggtitle("Number of passengers vs tip percentage")
```
...
processed_df %>%
  ...
  geom_boxplot() +
  theme(legend.position = "none") +
  labs(y = "Percentage tip amount [$]", x = "Vendor ID") + ggtitle("Vendor ID vs Tip Percentage")
```
...
hist(processed_df$trip_duration, processed_df$per_tip, main = "Histogram of Trip Duration vs Tip Percentage", col = rainbow(40), breaks = 40, xlab = "Trip Duration (min)", ylab = "Tip Percentage" )
```

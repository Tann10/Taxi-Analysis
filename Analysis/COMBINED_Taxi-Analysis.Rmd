...
barplot(summary(processed_df$Borough_pu), main = "Trip Counts Based on Pickup Location", col = "red")
barplot(summary(processed_df$Borough_do), main = "Trip Counts Based on Dropoff Location", col = "blue")
```
...
plot(per_tip ~ Borough_pu, data = processed_df, main = "Tip Percentage by Pickup Location", xlab = "Location", ylab = "Tip Percentage", col = c("green", "blue", "red", "yellow", "purple", "grey", "orange"))

# Plot tip percentage by dropoff location
plot(per_tip ~ Borough_do, data = processed_df, main = "Tip Percentage by Dropoff Location", xlab = "Location", ylab = "Tip Percentage", col = c("green", "blue", "red", "yellow", "purple", "grey", "orange"))
```
...
plot(tip_amount ~ Borough_pu, data = processed_df, main = "Tip Amount by Pickup Location", xlab = "Location", ylab = "Tip Amount", col = c("green", "blue", "red", "yellow", "purple", "grey", "orange"))

# Plot rankings vs GRE
plot(tip_amount ~ Borough_do, data = processed_df, main = "Tip Amount by Drop offLocation", xlab = "Location", ylab = "Tip Percentage", col = c("green", "blue", "red", "yellow", "purple", "grey", "orange"))
```

...
processed_df %>%
  ...
  geom_histogram(aes(y =..density..),
                   colour = "black",
                   fill = "blue") + stat_function(fun = dnorm, args = list(mean = mean(processed_df$per_tip), sd = sd(processed_df$per_tip))) + ggtitle("Distribution of NYC Taxi Tip Data Post-Outlier Removal")
```
